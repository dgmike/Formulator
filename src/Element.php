...
{
    /**
     * The form. Its is setted in all form elemens if its generated by
     * $form->addElement()
     *
     * @protected Apolo_Component_Formulator
     */
    protected $form;
    ...
    public function setSubElements(array $subElements)
    {
        ...
        foreach ($subElements as $element) {
            $element = Apolo_Component_Formulator::element($element, $form);
