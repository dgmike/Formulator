...
class Apolo_Component_Formulator_Element_RadioTest
    extends PHPUnit_Framework_TestCase
{
    ...
    public function testRenderRadios()
    {
        $this->form->addElement(array(
            'type'   => 'radio',
        ...
        $expected = '<fieldset>' . PHP_EOL
                  ...
                  . '    </legend>' . PHP_EOL
                  . '    <label>' . PHP_EOL
                  . '        <input type="radio" name="movies[]" value="the saw" />' . PHP_EOL
                  . '        <span>' . PHP_EOL
                  . '            The saw' . PHP_EOL
                  . '        </span>' . PHP_EOL
                  . '    </label>' . PHP_EOL
                  . '    <label>' . PHP_EOL
                  . '        <input type="radio" name="movies[]" value="friday, 13th" />' . PHP_EOL
                  . '        <span>' . PHP_EOL
                  . '            Friday, the 13th' . PHP_EOL
                  . '        </span>' . PHP_EOL
                  . '    </label>' . PHP_EOL
                  . '    <label>' . PHP_EOL
                  . '        <input type="radio" name="movies[]" value="elm street" />' . PHP_EOL
                  . '        <span>' . PHP_EOL
    ...
    public function testClassAndIdGoesToFieldset()
    {
        ...
        $expected = '<fieldset id="accept" class="fieldset">' . PHP_EOL
                  ...
                  . '    </legend>' . PHP_EOL
                  . '    <label>' . PHP_EOL
                  . '        <input type="radio" name="accept[]" value="yes" />' . PHP_EOL
                  . '        <span>' . PHP_EOL
                  . '            Yes, I do.' . PHP_EOL
                  . '        </span>' . PHP_EOL
                  . '    </label>' . PHP_EOL
